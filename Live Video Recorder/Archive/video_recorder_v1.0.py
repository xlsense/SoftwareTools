...
parser.add_argument('--username', '-u', type=str, help="Username to access the camera")	
parser.add_argument('--password', '-p', type=str, help="Password to access the camera")
...
stream_url = "rtsp://{0}:{1}@{2}:{3}/snl/live/1/1".format(args.username, args.password, args.ip, port)
